...
type Local struct {
	ProtocolVersion  *string `protobuf:"bytes,1,opt,name=protocolVersion,def=3.0.5" json:"protocolVersion,omitempty"`
...
const Default_Local_ProtocolVersion string = "3.0.5"
...
type Command_Header struct {
	...
	TimeQuanta       *int64 `protobuf:"varint,13,opt" json:"TimeQuanta,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}
...
type Command_GetLog_Configuration_Interface struct {
	Name             *string `protobuf:"bytes,1,opt,name=name" json:"name,omitempty"`
	MAC              []byte  `protobuf:"bytes,2,opt" json:"MAC,omitempty"`
...
type Command_Security_ACL_Scope struct {
	...
	TlsRequired      *bool                             `protobuf:"varint,4,opt" json:"TlsRequired,omitempty"`
	XXX_unrecognized []byte                            `json:"-"`
}
